//
//  LYDContentPageFullViewController.m
//  LYAdSDKDemo
//
...
@interface LYDContentPageFullViewController () <LYContentPageDelegate, LYContentPageContentDelegate, LYContentPageVideoDelegate>
@property (nonatomic, strong) LYContentPage * contentPage;
@end

@implementation LYDContentPageFullViewController
